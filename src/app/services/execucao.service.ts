...
export class ExecucaoService {
  ...
  constructor(private executavelService: ExecutavelService) {
    ...
    const eventos = [
      ...
      new Evento('Geração do relatório concluída', StatusEvento.Sucesso),
    ];
  ...
  pararExecucao(execucao: Execucao): void {
    const evento = new Evento('Pedido de interrupção disparado', StatusEvento.Erro);
